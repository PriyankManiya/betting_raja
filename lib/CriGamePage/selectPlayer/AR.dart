...
class AR extends StatefulWidget {
  ...
  AR({this.players,this.Names});
  @override
  _ARState createState() => _ARState();
}

class _ARState extends State<AR> {
  List<String> teams = [ "MI", "CSK","MI","MI","CSK","CSK",  "CSK","CSK",];
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.builder(
                itemCount: widget.players[0][2].length,
                itemBuilder: (context, index) {
                  return Table(
                    ...
                    children: [
                      TableRow(children: [
                        Image.asset(
                          "assets/players/CSK vs MI/${widget.players[0][2][index]}",
                          height: 70,
                        ),
                        Padding(
                          padding: const EdgeInsets.symmetric(vertical: 10),
